...
using JustAProgrammer.TeamPilgrim;

namespace TeamPilgrim_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new TeamPilgrimPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(JustAProgrammer.TeamPilgrim.GuidList.guidTeamPilgrimCmdSet, (int)JustAProgrammer.TeamPilgrim.PkgCmdIDList.cmdTeamPilgrim);
