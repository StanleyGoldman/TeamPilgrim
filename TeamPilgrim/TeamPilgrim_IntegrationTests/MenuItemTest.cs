...
namespace TeamPilgrim_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(JustAProgrammer.TeamPilgrim.GuidList.guidTeamPilgrimCmdSet, (int)JustAProgrammer.TeamPilgrim.PkgCmdIDList.cmdTeamPilgrim);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "TeamPilgrim", "JustAProgrammer.TeamPilgrim.TeamPilgrimPackage");
